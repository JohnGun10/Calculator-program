...
def test_addition_when_memory_value_equal_to_negative_one_negative_range():
	"""test of add method to see how it handles when you pass range from -4 to -2 and class
...
def test_subtraction_when_memory_value_equal_to_negative_one_positive_range():
	"""test of subtract method to see how it handles when you pass range from
		2 to 4 and class is initialized to negative one"""
	_calculator = Calculator(-1)
	for a in range(2, 4):
		if a == 2:
...
def test_subtraction_when_memory_value_equal_to_negative_one_negative_range():
	"""test of subtract method to see how it handles when you pass range from
		-4 to -2 and class is initialized to negative one"""
	_calculator = Calculator(-1)
	for a in range(-4, -2):
		if a == -4:
			assert _calculator.subtract(a) == 3
...
def test_division_when_memory_value_equal_to_negative_one_positive_range():
	"""test of divide method to see how it handles when you pass positive numbers and class
	is initialized to negative one"""
	_calculator = Calculator(-1)
	for a in range(2, 4):
		if a == 2:
...
def test_division_when_memory_value_equal_to_negative_one_negative_range():
	"""test of divide method to see how it handles when you pass negative numbers and class
	is initialized to negative one"""
	_calculator = Calculator(-1)
	for a in range(-4, -2):
		if a == -4:
